...
CSV_FILES = [ 
    '../Data/telemetry_dirt-corolla (1).csv', '../Data/telemetry_etrack-corolla.csv',
    '../Data/telemetry_dirt-evo (1).csv', '../Data/telemetry_dirt-p406 (1).csv',
    '../Data/telemetry_log_unknown (1).csv', '../Data/telemetry_oval (1).csv',
    '../Data/telemetry_oval-p406 (2).csv', '../Data/telemetry_oval-pw-evoviwrc (2).csv', 
    '../Data/telemetry_etrack.csv'
]
